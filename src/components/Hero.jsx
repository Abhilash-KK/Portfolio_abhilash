          ...
          <ScrollReveal className="flex flex-col items-start text-left">
            ...
            <div className="flex flex-wrap gap-4 items-center w-full">
              ...
              <button
                ...
                onMouseEnter={playHover}
                className="font-display text-[0.8rem] font-bold tracking-widest border border-white/20 hover:border-primary/50 text-white bg-transparent hover:bg-white/5 px-8 py-4 uppercase transition-all duration-300 hover:-translate-y-0.5 flex items-center gap-2 cursor-pointer"
              >
                <i className="fas fa-eye text-xs text-slate-400"></i>
